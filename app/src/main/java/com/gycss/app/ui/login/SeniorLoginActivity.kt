...
@AndroidEntryPoint
class SeniorLoginActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySeniorLoginBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySeniorLoginBinding.inflate(layoutInflater)
    ...
    private fun setupListeners() {
        ...
        binding.tvRegister.setOnClickListener {
            startActivity(Intent(this, SeniorRegistrationActivity::class.java))
        }
    }
